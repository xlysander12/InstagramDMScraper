...
class IClipMessage(IMessage):
    def __init__(self, id: int, sender_id: int, timestamp: datetime, clip_sender_username: str, clip_caption: str, clip_url: str):
    ...
    def print(self) -> str:
        return f"Clip from {self.clip_sender_username} titled \"{self.clip_caption}\" -> {self.clip_url}"
